...
for L in 'ABC':
    ...
    # instruction.append(ord(' '))
    # instruction.append(ord(L))
    # instruction.append(ord(' '))
    # instruction.append(ord('T'))
    ...
    # instruction.append(ord('T'))
    # instruction.append(ord(' '))
    # instruction.append(ord('J'))
    # instruction.append(10)
    inputs.append(instruction)
instruction = deepcopy(AND)
instruction.append(ord(' '))
instruction.append(ord('D'))
instruction.append(ord(' '))
instruction.append(ord('J'))
instruction.append(10)
inputs.append(instruction)
inputs.append([ord('W'), ord('A'), ord('L'), ord('K'), 10])
